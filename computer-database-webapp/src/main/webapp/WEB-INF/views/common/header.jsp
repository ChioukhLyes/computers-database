	...
	<header class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			...
			<ul class="notifications" id="languagesMenu">
				...
				<li class="notifbox">
					<ul class="notif">
						<li><a id="languagesChangeFr"
							onclick="updateQueryStringParameter('language','fr')">
								<ul class="imageblock">
					...
					<ul class="notif">
						<li><a id="languagesChangeEn"
							onclick="updateQueryStringParameter('language','en')">
								<ul class="imageblock">
